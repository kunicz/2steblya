...
var productPriceLevels = {
	'2steblya': {
		6000: ['букетусик', 'сердечко', 'кастрюлька', 'яичко'],
		10000: ['букетик', 'сердце', 'кастрюля', 'ящичек', 'яйцо', 'аквариумчик'],
		15000: ['букет', 'кастрюлища', 'корзиночка', 'горшок', 'ящик', 'аквариум'],
		20000: ['букетище'],
