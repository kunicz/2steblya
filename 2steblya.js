console.log(222);/* корзина включена/выключена */
var cartEnabled = true;
/* форма заказа в корзине сокращенная/полная */
var cartExpanded = false;
/* уровни цен товаров */
var productPriceLevels = {
	6000: ['букетусиком', 'сердечком', 'в кастрюльке', 'сыграем в ящичек'],
	10000: ['букетиком', 'сердцем', 'в кастрюле', 'сыграем в ящик'],
	15000: ['букетом', 'в кастрюлище', 'корзиночку сварганим'],
	20000: ['букетищем'],
	25000: ['коробку забубеним', 'корзинку забубеним'],
	35000: ['корзину зафигачим'],
	50000: ['букетищищем', 'корзинищу жахнем']
};
